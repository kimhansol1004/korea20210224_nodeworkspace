...
class Hero extends GameObject{
    constructor(container, src, width, height, x, y, velX, velY){
        ...
        this.jump = false; //주인공의 점프상태를 판단할수 있는 변수 (즉 점프하는지 안하는지)
    }
    ...
    tick(){
        //코드에는 보이지 않지만, 현재 클래스는 GameObject의 모든것을 다 가지고 
        //있는 것과 마찬가지다 즉 내것처럼 접근할 수 있다
        ...
        for(var i=0; i<blockArray.length; i++){
           ...
           if(onBlock && this.jump==false){ 
               this.velY = 0; //점프버튼을 눌르면, velY 값을 0으로 묶어놓지 말자
