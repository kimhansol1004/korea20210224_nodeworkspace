/*
Node.js는 웹브라우저에서 사용되는 js문법을 거의 그래도 사용하기 때문에
자체적인 능력이 한계가 있다. 하지만 모듈을 통해 
엄청난 확장성을 갖고 있다 (전세계 개발자들에 의해 모듈이 오픈소스로 공유된다)
*/

//기본적으로 웹서버 모듈 가져오기
//http 등의 모듈을 이미 node.js 설치시 함께 포함이 된다. 이러한 내장된 모듈을
//가리켜 내장모듈이라 한다
